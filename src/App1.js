    ...
    return (
      ...
      <div>
        ...
        <Route exact path='/student' element={<Student/>}/>
          ...
          <Route exact path='/marksheet/:studentId' element={<Marksheet/>}/>
          <Route exact path='/college/:name' element={<College/>}/>
          <Route exact path='/student/:collegeId' element={<Student/>}/>
          {/* <Route exact path='/role/:id' element={<Role/>}/> */}
          <Route exact path='/user/:empId' element={<User/>}/>
        </Routes>
